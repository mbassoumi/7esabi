  ...
  translations: {
    ...
    accountGroup: {
      ...
      form: {
        ...
        inputAccountGroupArchived: 'الارشيف',
        archivedWarning: {
          title: 'الأرشيف',
          body: 'عند حفظ مجموعة الحسابات في الأرشيف ستختفي تلقائيا من القائمة في الصفحة الرئسية (لكن لن يخذف أي شيء).. يمكنك دوما رؤية المجموعات المحفوظة في الأرشيف او اعادتها',
        },
      },
      deleteForm: {
        title: 'حذف مجموعة الحسابات',
        body: 'هل انت متأكد أنك تريد حذف المجموعة؟ جميع الحسابات داخل هذه المجموعة (بما فيها الأرشيف) سيتم حذفها، بالاضافة الى جميع الحركات على تلك الحسابات',
      },
    },
    ...
    account: {
      ...
      form: {
        ...
        archivedWarning: {
          title: 'الأرشيف',
          body: 'عند حفظ الحساب في الأرشيف سيختفي تلقائيا من قائمة الحسابات في الصفحة الرئسية (لكن لن يخذف أي شيء).. يمكنك دوما رؤية الحسابات المحفوظة في الأرشيف او اعادتها',
        },
      },
      deleteForm: {
        title: 'حذف الحساب',
