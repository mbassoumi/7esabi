  ...
  translations: {
    ...
    accountGroup: {
      ...
      deleteForm: {
        ...
        body:
          'هل انت متأكد أنك تريد حذف المجموعة؟ جميع الحسابات داخل هذه المجموعة سيتم حذفها، بالاضافة الى جميع الحركات على تلك الحسابات',
      },
    },
    ...
    account: {
      ...
      deleteForm: {
        title: 'حذف الحساب',
        body:
          'هل انت متأكد أنك تريد حذف الحساب؟ جميع الحركات المالية على هذا الحساب سيتم حذفها أيضا',
      },
      currency: {
        NIS: 'شيكل',
        USD: 'دولار/دولارات',
    ...
    accountPermission: {
      form: {
        ...
        explanation: {
          ...
          body:
            'جميع الأشخاص في هذه القائمة يمكنهم رؤية الحساب والحركات المالية عليه. لكن، فقظ الأشخاص الذين تم تفعيل "صلاحية الإضافة" لهم يمكنهم اضافة حركات مالية للحساب.',
        },
      },
      list: {
