  ...
  translations: {
    ...
    accountGroup: {
      ...
      form: {
        ...
        archivedWarning: {
          title: 'الأرشيف',
          body: 'عند حفظ الحساب في الأرشيف سيختفي تلقائيا من قائمة الحسابات في الصفحة الرئسية (لكن لن يخذف أي شيء).. يمكنك دوما اظهاره الحسابات المحفوظة في الأرشيف او اعادتها ',
        },
